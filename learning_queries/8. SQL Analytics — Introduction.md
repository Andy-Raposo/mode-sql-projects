...
The following section aims to replicate real problems of analysis, beyond SQL syntax, to understand the application of what we are measuring with this tool.

This section will start with Yammer, a social network to communicate with coworkers, share docs, or ideas by posts within groups. Yammer has a centralized Analytics team, which sits in the Engineering organization and whose goal is to drive better product and business decisions using data. 
...
All of these cases will be developed in the following files tagged "SQL Analytics," on a case-per-case basis.